...
def ayuda_gestos():
    ...
    new_window.title("Imagen Flotante")
    new_window.geometry("2944x1296")  # Ajusta el tamaño según necesites
    
    # Cargar la imagen
    img = PhotoImage(file="img/GESTOS_AYUDA.png")  # Reemplaza con tu ruta de imagen
